...
isxdl_langfile=portugues.ini
  
;en.depdownload_msg=The following applications are required before setup can continue:%n%n%1%nDownload and install now?
depdownload_msg=As seguintes aplicações são necessárias antes de a instalação poder continuar:%n%n%1%nDeseja realizar o download e as instalar agora? É necessária uma ligação à Internet.  

;en.depdownload_memo_title=Download dependencies
depdownload_memo_title=Download das dependências

;en.depinstall_memo_title=Install dependencies
depinstall_memo_title=Instalar dependências

;en.depinstall_title=Installing dependencies
depinstall_title=A instalar dependências

;en.depinstall_description=Please wait while Setup installs dependencies on your computer.
depinstall_description=Por favor aguarde enquanto as dependências são instaladas no seu computador.

;en.depinstall_status=Installing %1...
depinstall_status=A instalar %1...

;en.depinstall_missing=%1 must be installed before setup can continue. Please install %1 and run Setup again.
depinstall_missing=%1 deve ser instalado antes de se poder continuar. Por favor instale o %1 e execute o instalador novamente.

;en.depinstall_error=An error occured while installing the dependencies. Please restart the computer and run the setup again or install the following dependencies manually:%n
depinstall_error=Ocorreu um erro enquanto as dependências eram instaladas. Reinicie o computador e execute o instalador novamente ou instale as seguintes dependências novamente:%n
